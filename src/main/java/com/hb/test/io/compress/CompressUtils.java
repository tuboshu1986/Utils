package com.hb.test.io.compress;
 ...
 * @Description:
 * @author 黄泊
 * @date 2018年9月19日 上午10:54:40
 *
 */
public class CompressUtils {

	public static void main(String[] args) throws Exception {
		String srcFilePathRar = "C:/Users/DELL/Desktop/temp/temp.zip";
		String destDirPath = "C:/Users/DELL/Desktop/temp/2";
		unzip(srcFilePathRar, destDirPath);
	}
	...
	public static void deCompress(String sourceFile, String destDir)
		...
		if (type.equals("zip")) {
			CompressUtils.unzip(sourceFile, destDir);
		} else if (type.equals("rar")) {
			CompressUtils.unrar(sourceFile, destDir);
		} else {
